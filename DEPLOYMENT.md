...
sudo service unicorn_graff_tracker <start|stop|restart>
sudo service sidekiq_graff_tracker <start|stop>
```
...
```
/home/deployer/apps/graff_tracker/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_graff_tracker restart
sudo service sidekiq_graff_tracker stop
sudo service sidekiq_graff_tracker start
```
